...
var Strategy = function(options, verify) {
  ...
  options.authorizationURL = options.baseURL + (options.authorizationURL || '/account/authorize');
  options.tokenURL = options.baseURL + (options.tokenURL || '/oauth2/v1/token');
  options.revokeURL = options.baseURL + (options.revokeURL || '/oauth2/v1/revoke');
  options.logoutURL = options.baseURL + (options.logoutURL || '/account/logout');
